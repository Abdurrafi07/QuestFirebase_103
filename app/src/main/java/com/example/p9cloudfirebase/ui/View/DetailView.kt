...
import com.example.p9cloudfirebase.ui.Navigation.DestinasiNavigasi
import com.example.p9cloudfirebase.ui.ViewModel.DetailUiState
import com.example.p9cloudfirebase.ui.ViewModel.DetailViewModel
...
fun DetailScreen(
    ...
    Scaffold(
        ...
        topBar = {
            com.example.p9cloudfirebase.ui.CustomWidget.TopAppBar(
...
fun ItemDetailMhs(
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            ComponentDetailMhs(judul = "Pembimbing2", isinya = mahasiswa.pembimbing2)
            Spacer(modifier = Modifier.height(8.dp))
        }
    }
}
